...
const { getAllCareerByIdStudent,getAllSubjectsByCareer, AddProgramming, getNotesByIdStudent, getAllStudentsByIdEnable, updateNotes, getAllEvaluationByIdStudent } = require('./programmingService');
